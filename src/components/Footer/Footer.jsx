...
const Footer = () => {
    return (
        ...
        <InputGroup.Text>Send</InputGroup.Text>
            ...
            <p><small className='text-warning'>goodfood@gmail.com</small></p>
            <p className='pt-5 text-white'><small>Copyright © 2012 - 2023 TermsFeed®. All rights reserved.</small></p>
        </div>
    );
};
